- [Symbolic AI](#symbolic-ai)
  ...
  - [Techniques and Methodologies](#techniques-and-methodologies)
    - [1. Logic-based techniques](#1-logic-based-techniques)
      - [References for Logic Programming (Prolog-style Unification in Python)](#references-for-logic-programming-prolog-style-unification-in-python)
    - [2. Rule-based systems](#2-rule-based-systems)
      - [References](#references-1)
    - [3. Search-based symbolic methods](#3-search-based-symbolic-methods)
      - [References](#references-2)
    - [4. Knowledge representation frameworks](#4-knowledge-representation-frameworks)
      - [References](#references-3)
    - [5. Planning and reasoning](#5-planning-and-reasoning)
    - [6. Case-based and model-based reasoning](#6-case-based-and-model-based-reasoning)
    - [7. Knowledge engineering methodologies](#7-knowledge-engineering-methodologies)
    - [8. Symbolic Natural Language Processing (pre-ML era)](#8-symbolic-natural-language-processing-pre-ml-era)
      - [References](#references-4)
  - [Symbolic AI techniques in Python](#symbolic-ai-techniques-in-python)
    - [1. Rule-Based System (IF–THEN rules, forward chaining)](#1-rule-based-system-ifthen-rules-forward-chaining)
    - [2. Logic Programming with kanren (Prolog-style unification)](#2-logic-programming-with-kanren-prolog-style-unification)
    - [3. Search in a Symbolic State Space](#3-search-in-a-symbolic-state-space)
    - [4. Symbolic Knowledge Representation (Semantic Network)](#4-symbolic-knowledge-representation-semantic-network)
    - [5. Natural Language Parsing with CFGs (symbolic NLP)](#5-natural-language-parsing-with-cfgs-symbolic-nlp)
  - [Which are Still Relevant / Actively Used?](#which-are-still-relevant-actively-used)
    - [1. Rule-Based Systems (Business Rules Engines)](#1-rule-based-systems-business-rules-engines)
    - [2. Constraint Logic & Constraint Solvers](#2-constraint-logic-constraint-solvers)
    - [3. Search Algorithms (Symbolic State-Space Search)](#3-search-algorithms-symbolic-state-space-search)
    - [4. Knowledge Representation (Ontologies, Semantic Web)](#4-knowledge-representation-ontologies-semantic-web)
    - [5. Rule-Based NLP (Symbolic + ML Hybrid Systems)](#5-rule-based-nlp-symbolic-ml-hybrid-systems)
  - [Less Common Today (Mostly Academic/Legacy)](#less-common-today-mostly-academiclegacy)
  - [Bottom Line for Developers](#bottom-line-for-developers)
  - [Symbolic AI Methods by Job Domain](#symbolic-ai-methods-by-job-domain)
    - [Fintech / Banking / Insurance](#fintech-banking-insurance)
    - [Healthcare / Biotech](#healthcare-biotech)
    - [Logistics / Supply Chain / Manufacturing](#logistics-supply-chain-manufacturing)
    - [Game Development](#game-development)
    - [Robotics / Autonomous Systems](#robotics-autonomous-systems)
    - [Web / Enterprise Software](#web-enterprise-software)
    - [LegalTech / GovTech](#legaltech-govtech)
